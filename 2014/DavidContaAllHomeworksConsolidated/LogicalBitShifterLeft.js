/**THIS IS THE BIT SECOND BIT SHIFTER DEMANDED FOR TP6 :
 *IT IMPLEMENTS A  1 BIT LEFT LOGICAL BITSHIFT AS DEFINED HERE :  http://en.wikipedia.org/wiki/Logical_shift
...
addOneMachine.stateTransition = {
    ...
    "b": {
        //we then find the LSB and finish the shift
        "0": ["0", "right", "b"],
        "1": ["1", "right", "b"],
        "": ["0", "left", "stop"]
    },
