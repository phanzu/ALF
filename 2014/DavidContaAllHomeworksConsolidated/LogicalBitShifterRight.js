/**THIS IS THE BIT FIRST BIT SHIFTER DEMANDED FOR TP6 :
 *IT IMPLEMENTS A  1 BIT RIGHT LOGICAL BITSHIFT AS DEFINED HERE :  http://en.wikipedia.org/wiki/Logical_shift
 * THIS IS MEANT TO BE RUN WITH THE KHAN ACADEMY TURING MACHINE  : https://www.khanacademy.org/cs/turing-machine/938201372
 *
...
addOneMachine.stateTransition = {
    "start": {
        //Here we find the number's MSB and shift the most significant bit
        "0": ["0", "left", "start"],
        "1" : ["1", "left", "start"],
        "": ["0", "right", "a"]
    },
    ...
    "b": {
        //we then empty the former LSB finishing the shift
        "0": ["", "left", "stop"],
        "1": ["", "left", "stop"],
        "": ["", "right", "stop"]
    },
