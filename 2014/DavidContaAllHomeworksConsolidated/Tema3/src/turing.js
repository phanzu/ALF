...
turing.winLevel_ = function(opt_index) {
  ...
  // 
  if (turing.isInBonusMode() && !letterIndex == 5  /* 'e'. */) { //!turing becomes turing
...
turing.init = function() {
  ...
  turing.setOpHighlightColor('y');
  turing.program_ = new turing.Program();
  //101010101010312313131313131313131311313131313131313133312312323123451514543523452353523
  turing.gameOver_ = true; //false changed to true 
  turing.numFailures_ = 0;
